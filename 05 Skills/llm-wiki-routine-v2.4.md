...
3. **Auto-retire (time-aware window — AMENDED at the v151 audit, 2026-06-04, operator sign-off).** A standalone N=1 is auto-retired at the next audit only once it has gone **both ≥15 wikis AND ≥30 days** without strengthening (i.e. retire on the threshold satisfied *later* — "15 wikis OR 30 days, whichever is longer"). Checked mechanically against the registry. **Rationale:** the original wiki-count-only "15 wikis" rule mis-fires during burst-shipping — the v126–v151 window shipped 25 wikis in ~3 calendar days, which would mechanically retire days-old CORPUS-FIRST items as "stale." The 30-day floor protects recent items during bursts; the 15-wiki ceiling still retires genuinely-stale items during slow cadence. Retired items remain re-registerable on a genuine 2nd instance.
