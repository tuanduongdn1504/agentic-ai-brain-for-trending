...
**Source:** https://transform.sg.larksuite.com/wiki/HbeIwHVC3i2rlsk45MSlIipOg0d
**Wiki ID:** HbeIwHVC3i2rlsk45MSlIipOg0d
**Archived:** 2026-05-07
...
Log In or Sign Up
6.58 - Giới thiệu MCP — Model Context Protocol
Bài 6.58: Giới thiệu MCP — Model Context Protocol
Mục tiêu học tập
Mở đầu: Scale khi có 50 integrations
...
Mở đầu: Scale khi có 50 integrations​
Bạn build chatbot cho enterprise. Cần tools:​
•
GitHub (list repos, PRs, issues)​
•
Slack (send msg, read channels)​
•
...
•
...​
Mỗi integration = 10-50 tool schemas + functions. 50 integrations × 30 tools = 1500 tools bạn maintain.​
Mỗi thay đổi API upstream (Slack update v2) → bạn update 30 tool functions.​
Unsustainable.​
MCP = "Language for tool providers"​
