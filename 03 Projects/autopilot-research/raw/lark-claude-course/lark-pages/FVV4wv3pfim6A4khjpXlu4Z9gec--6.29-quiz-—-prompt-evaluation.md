...
**Source:** https://transform.sg.larksuite.com/wiki/FVV4wv3pfim6A4khjpXlu4Z9gec
**Wiki ID:** FVV4wv3pfim6A4khjpXlu4Z9gec
**Archived:** 2026-05-07
...
Log In or Sign Up
6.29 - Quiz — Prompt Evaluation
Bài 6.29: Quiz — Prompt Evaluation
Giới thiệu
Câu hỏi
Câu 1
Câu 2
...
Câu hỏi​
Câu 1​
Sự khác biệt chính giữa prompt engineering và prompt evaluation?​
A) Engineering viết prompt, evaluation đo chất lượng promptB) Engineering cho Sonnet, evaluation cho HaikuC) Không khác nhauD) Engineering là lý thuyết, evaluation là thực hành​
Câu 2​
Option nào là production-safe sau khi viết prompt?​
A) Test 1 case rồi shipB) Test 5 case, fix 1 edge rồi shipC) Build full eval pipeline với dataset + graderD) Không test gì​
Câu 3​
5 bước của typical eval workflow theo thứ tự đúng là:​
A) Draft → Dataset → Run → Grade → IterateB) Dataset → Draft → Grade → Run → IterateC) Iterate → Draft → Run → Dataset → GradeD) Run → Grade → Draft → Iterate → Dataset​
Câu 4​
Dataset size minimum để score stable?​
Comments (0)
Help Center
Keyboard Shortcuts
