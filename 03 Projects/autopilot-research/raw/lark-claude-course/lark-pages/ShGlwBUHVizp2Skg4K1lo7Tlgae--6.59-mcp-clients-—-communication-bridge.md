...
**Source:** https://transform.sg.larksuite.com/wiki/ShGlwBUHVizp2Skg4K1lo7Tlgae
**Wiki ID:** ShGlwBUHVizp2Skg4K1lo7Tlgae
**Archived:** 2026-05-07
...
Log In or Sign Up
6.59 - MCP clients — Communication bridge
Bài 6.59: MCP clients — Communication bridge
Mục tiêu học tập
Mở đầu: Client không phải end-user UI
Transport agnostic
stdio (common)
HTTP
WebSocket
...
User UI​
   │​
   ▼​
Your server / backend ← app code​
   │​
   ├─ Anthropic client (call Claude)​
   └─ MCP client (call MCP servers)​
      │​
      ▼​
MCP servers (GitHub, Slack, custom, ...)​
​
​
MCP client = 1 component backend của bạn.​
​
​
Transport agnostic​
