...
**Source:** https://transform.sg.larksuite.com/wiki/U6jZwGdCqiWT29k2HWylwV4agng
**Wiki ID:** U6jZwGdCqiWT29k2HWylwV4agng
**Archived:** 2026-05-07
...
Log In or Sign Up
6.37 - Dùng nhiều tools cùng lúc — Adding tools to your system
Bài 6.37: Dùng nhiều tools cùng lúc — Adding tools to your system
Mục tiêu học tập
Mở đầu: Scale từ 1 tool lên 10
4-step để thêm tool
...
Nếu code structure đúng: Adding tool = 3 bước đơn giản, không refactor.​
Nếu không: Mỗi tool mới = rewrite logic.​
Bài này là "thực hành" scaling.​
4-step để thêm tool​
Bước 1: Viết function​
​
Code block​
