...
**Source:** https://transform.sg.larksuite.com/wiki/AxZNw5xe5ioAL8kWxKEltjmzgvc
**Wiki ID:** AxZNw5xe5ioAL8kWxKEltjmzgvc
**Archived:** 2026-05-07
...
Log In or Sign Up
6.64 - Định nghĩa prompts qua MCP
Bài 6.64: Định nghĩa prompts qua MCP
Mục tiêu học tập
Mở đầu: Prompt = "expert knowledge packaged"
Why MCP prompts?
Implement prompt
...
Scenario: User muốn "convert document to markdown". Could just type "convert to markdown", but pre-built prompt from expert gives better consistency.​
MCP server author publish prompt → users benefit tiny upfront cost.​
Why MCP prompts?​
​
Code block​
Plain Text
