...
**Source:** https://transform.sg.larksuite.com/wiki/A5OQw3Q1DiaIKjkF1QmlPfNBghf
**Wiki ID:** A5OQw3Q1DiaIKjkF1QmlPfNBghf
**Archived:** 2026-05-07
...
Log In or Sign Up
6.70 - Workflows vs Agents — Pattern nào khi nào?
Bài 6.70: Workflows vs Agents — Pattern nào khi nào?
Mục tiêu học tập
Mở đầu: 2 cách build AI apps
Workflow
Example
Agent
Example
...
Workflow: Bạn pre-define sequence of steps. Claude thực thi từng bước.​
Agent: Bạn give Claude goals + tools. Claude tự plan sequence.​
Trông giống, behavior khác biệt. Chọn sai → app unreliable hoặc over-engineered.​
Workflow​
...
Plain Text
Copy
User task → Step 1 (Claude) → Step 2 (Claude) → Step 3 (code) → ... → Output​
​
​
