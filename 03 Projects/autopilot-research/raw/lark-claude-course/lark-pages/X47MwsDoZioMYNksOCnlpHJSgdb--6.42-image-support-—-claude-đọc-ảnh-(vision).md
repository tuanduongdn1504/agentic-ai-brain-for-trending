...
**Source:** https://transform.sg.larksuite.com/wiki/X47MwsDoZioMYNksOCnlpHJSgdb
**Wiki ID:** X47MwsDoZioMYNksOCnlpHJSgdb
**Archived:** 2026-05-07
...
Log In or Sign Up
6.42 - Image support — Claude đọc ảnh (Vision)
Bài 6.42: Image support — Claude đọc ảnh (Vision)
Mục tiêu học tập
Mở đầu: Claude "nhìn thấy"
Limits
...
Extract text (OCR)​
•
Analyze diagram / chart​
•
Compare 2 images​
•
Identify object, scene, style​
•
Medical imaging (với disclaimer)​
•
