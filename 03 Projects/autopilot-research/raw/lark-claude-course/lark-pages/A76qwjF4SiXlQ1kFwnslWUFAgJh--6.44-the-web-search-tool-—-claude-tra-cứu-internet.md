...
**Source:** https://transform.sg.larksuite.com/wiki/A76qwjF4SiXlQ1kFwnslWUFAgJh
**Wiki ID:** A76qwjF4SiXlQ1kFwnslWUFAgJh
**Archived:** 2026-05-07
...
Log In or Sign Up
6.44 - The web search tool — Claude tra cứu internet
Bài 6.44: The web search tool — Claude tra cứu internet
Mục tiêu học tập
Mở đầu: Real-time knowledge
Enable
Response structure
Extract
...
Mở đầu: Real-time knowledge​
Claude's training data có cutoff (ví dụ 1/2026). Hỏi:​
•
"Giá vàng hôm nay?" → không biết​
•
"Kết quả bầu cử tuần trước?" → không biết​
•
"Claude model mới nhất?" → biết đến lúc train​
Web search tool giải quyết — Claude search Google-like, đọc kết quả, reply với citations.​
Enable​
