...
**Source:** https://transform.sg.larksuite.com/wiki/PrFtwLt6OiCUrnkXJNWl9oaUguf
**Wiki ID:** PrFtwLt6OiCUrnkXJNWl9oaUguf
**Archived:** 2026-05-07
...
Log In or Sign Up
6.34 - Sending tool results — Gửi kết quả về Claude
Bài 6.34: Sending tool results — Gửi kết quả về Claude
Mục tiêu học tập
Mở đầu: Đóng vòng lặp
...
Bạn đã:​
•
Viết tool function (6.32)​
•
Viết schema (6.31)​
•
Nhận response multi-block (6.33)​
Bước cuối — execute function + gửi kết quả về Claude để Claude tạo final response.​
​
​
Execute tool function​
