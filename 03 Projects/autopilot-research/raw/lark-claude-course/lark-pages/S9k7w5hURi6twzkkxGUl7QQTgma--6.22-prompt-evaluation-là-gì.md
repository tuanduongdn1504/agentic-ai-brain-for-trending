...
**Source:** https://transform.sg.larksuite.com/wiki/S9k7w5hURi6twzkkxGUl7QQTgma
**Wiki ID:** S9k7w5hURi6twzkkxGUl7QQTgma
**Archived:** 2026-05-07
...
Log In or Sign Up
6.22 - Prompt evaluation là gì?
Bài 6.22: Prompt evaluation là gì?
Mục tiêu học tập
Mở đầu: Engineer xây cầu không "thử đi qua 1 lần rồi ship"
...
Họ:​
•
Tính toán tải trọng (structural analysis)​
•
Test với tải giả lập​
•
Audit an toàn​
•
Monitor sau khi khai trương​
Prompt engineering đang ở giai đoạn "thử đi qua rồi ship". Dev viết prompt, test 2-3 case thấy OK, đẩy lên prod. User gặp case chưa test → app hỏng → incident.​
Prompt evaluation là "structural analysis" cho prompt. Giai đoạn chín muồi của AI engineering không thể thiếu nó.​
Prompt engineering vs Prompt evaluation​
​
Code block​
Plain Text
