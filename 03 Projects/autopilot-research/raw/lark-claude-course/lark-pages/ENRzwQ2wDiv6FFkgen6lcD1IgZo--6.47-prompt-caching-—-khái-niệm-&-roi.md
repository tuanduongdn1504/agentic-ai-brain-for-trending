...
**Source:** https://transform.sg.larksuite.com/wiki/ENRzwQ2wDiv6FFkgen6lcD1IgZo
**Wiki ID:** ENRzwQ2wDiv6FFkgen6lcD1IgZo
**Archived:** 2026-05-07
...
Log In or Sign Up
6.47 - Prompt caching — Khái niệm & ROI
Bài 6.47: Prompt caching — Khái niệm & ROI
Mục tiêu học tập
Mở đầu: Claude "repeat work" mỗi request
Cơ chế
ROI
Pricing
Break-even
...
Nếu bạn gửi request 2 lần với cùng nội dung (ví dụ: system prompt dài 5K token + user question ngắn), Claude repeat 3 giai đoạn đầu hoàn toàn, dù kết quả y hệt request trước.​
Inefficient. Giống bạn tính lại 2 + 2 mỗi buổi sáng.​
Prompt caching giải quyết — Claude save preprocessing, reuse cho follow-up.​
​
​
Cơ chế​
​
