...
**Source:** https://transform.sg.larksuite.com/wiki/MRmlw7PfcituPskYFEcl7QSvgRc
**Wiki ID:** MRmlw7PfcituPskYFEcl7QSvgRc
**Archived:** 2026-05-07
...
Log In or Sign Up
6.57 - Multi-Index RAG pipeline — Extensible architecture
Bài 6.57: Multi-Index RAG pipeline — Extensible architecture
Mục tiêu học tập
Mở đầu: Beyond 2 indexes
...
​
Mở đầu: Beyond 2 indexes​
Real RAG systems có 3-5 indexes:​
•
Semantic (embeddings)​
•
BM25 (keyword)​
•
Title/metadata specific​
•
Domain-specific (finance, legal terms)​
Rather than hard-code, design for extensibility.​
​
​
SearchIndex protocol​
