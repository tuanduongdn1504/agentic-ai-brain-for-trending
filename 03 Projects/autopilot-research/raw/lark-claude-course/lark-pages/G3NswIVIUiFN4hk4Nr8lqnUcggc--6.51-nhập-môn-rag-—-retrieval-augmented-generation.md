...
**Source:** https://transform.sg.larksuite.com/wiki/G3NswIVIUiFN4hk4Nr8lqnUcggc
**Wiki ID:** G3NswIVIUiFN4hk4Nr8lqnUcggc
**Archived:** 2026-05-07
...
Log In or Sign Up
6.51 - Nhập môn RAG — Retrieval Augmented Generation
Bài 6.51: Nhập môn RAG — Retrieval Augmented Generation
Mục tiêu học tập
Mở đầu: 800 trang tài liệu, câu hỏi đơn giản
Option 1: Stuff — Dump toàn bộ
...
"Risk factors của công ty là gì?"​
Options:​
Option 1: Stuff — Dump toàn bộ​
​
Code block​
...
Vấn đề:​
•
800 trang ≈ 400K tokens → có thể vượt context window (Sonnet 1M OK, Opus 200K fail)​
•
Cost: 400K × $3/M = $1.20 mỗi query​
Comments (0)
Help Center
Keyboard Shortcuts
