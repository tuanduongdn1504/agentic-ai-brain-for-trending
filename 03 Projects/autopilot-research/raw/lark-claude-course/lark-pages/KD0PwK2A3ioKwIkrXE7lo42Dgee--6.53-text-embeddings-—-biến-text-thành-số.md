...
**Source:** https://transform.sg.larksuite.com/wiki/KD0PwK2A3ioKwIkrXE7lo42Dgee
**Wiki ID:** KD0PwK2A3ioKwIkrXE7lo42Dgee
**Archived:** 2026-05-07
...
Log In or Sign Up
6.53 - Text embeddings — Biến text thành số
Bài 6.53: Text embeddings — Biến text thành số
Mục tiêu học tập
Mở đầu: "Car" và "automobile" same meaning, different words
Embedding là gì?
...
Semantic search: cả 2 có ý nghĩa tương đồng → match.​
Embeddings = foundation của semantic search. Chúng biến text thành vector (list of numbers) mà meaning được encoded trong vị trí không gian.​
Embedding là gì?​
