...
**Source:** https://transform.sg.larksuite.com/wiki/R0FXwVlrNiTvJLk78GylWOUtgSl
**Wiki ID:** R0FXwVlrNiTvJLk78GylWOUtgSl
**Archived:** 2026-05-07
...
Log In or Sign Up
6.33 - Handling message blocks — Multi-block responses
Bài 6.33: Handling message blocks — Multi-block responses
Mục tiêu học tập
Mở đầu: Response không còn là 1 text block
Gọi API với tools
...
Khi dùng tool, response có thể có nhiều blocks:​
​
Code block​
Plain Text
Copy
response.content = [​
    TextBlock(text="I'll check the weather for you..."),  # ← block 1​
    ToolUseBlock(name="get_weather", input={"location": "SF"})  # ← block 2​
]​
​
​
Bạn cần handle cả 2.​
