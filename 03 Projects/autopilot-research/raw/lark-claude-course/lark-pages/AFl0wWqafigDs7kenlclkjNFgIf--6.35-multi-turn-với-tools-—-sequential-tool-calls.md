...
**Source:** https://transform.sg.larksuite.com/wiki/AFl0wWqafigDs7kenlclkjNFgIf
**Wiki ID:** AFl0wWqafigDs7kenlclkjNFgIf
**Archived:** 2026-05-07
...
Log In or Sign Up
6.35 - Multi-turn với tools — Sequential tool calls
Bài 6.35: Multi-turn với tools — Sequential tool calls
Mục tiêu học tập
Mở đầu: 1 tool không giải quyết được mọi thứ
Multi-turn flow
...
Claude cần:​
1.
Biết hôm nay là ngày nào → gọi get_current_datetime​
2.
Cộng 103 ngày → gọi add_duration_to_datetime​
3.
Format & trả lời user​
Đây là sequential tool calls — output tool 1 là input tool 2.​
Single-turn (1 tool, 1 response) không đủ. Cần loop.​
​
​
Multi-turn flow​
​
