...
**Source:** https://transform.sg.larksuite.com/wiki/Y1YFwpSEfivZF9k9k7slAkuQgab
**Wiki ID:** Y1YFwpSEfivZF9k9k7slAkuQgab
**Archived:** 2026-05-07
...
Log In or Sign Up
6.56 - BM25 lexical search — Hybrid với keyword
Bài 6.56: BM25 lexical search — Hybrid với keyword
Mục tiêu học tập
Mở đầu: "INC-2023-Q4-011" — semantic search fail
BM25 = "Best Match 25"
Cơ chế
Ví dụ
...
Semantic search:​
•
Top 1: Cybersecurity section (contains ID ✓)​
•
Top 2: Financial analysis (NO ID — false positive)​
Semantic match "concept" không phải "exact token". Incident ID là rare technical term — embedding mô hình không encode nó well.​
BM25 = classic algorithm give weight đến rare exact matches.​
BM25 = "Best Match 25"​
