...
**Source:** https://transform.sg.larksuite.com/wiki/ID8rw8v0IiYaAgkvWBZlq58jg1e
**Wiki ID:** ID8rw8v0IiYaAgkvWBZlq58jg1e
**Archived:** 2026-05-07
...
Log In or Sign Up
6.73 - Environment inspection — Agent phải "nhìn" được
Bài 6.73: Environment inspection — Agent phải "nhìn" được
Mục tiêu học tập
Mở đầu: Agent bị "bịt mắt"
...
Plain Text
Copy
Agent: edit_file("main.py", old="x=1", new="x=2")​
Result: "Edited"​
​
Agent's knowledge:​
  "I changed x=1 to x=2"​
​
Actual state:​
  main.py may have multiple "x=1". Which was replaced?​
  Or syntax error introduced?​
  Or file didn't have "x=1" at all?​
​
​
Without read after write, Claude assumes action worked. Often wrong → downstream failures.​
Example: Computer Use​
