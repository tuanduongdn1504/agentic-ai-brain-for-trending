...
**Honest disclosure on ratio drift:** the ratio rose 0.415 → 0.744 across v60→v69. Of the +0.329 drift: v66 audit disposed the v64+v65 observational queue (5 NEW candidates + 1 wiki-ship) for +0.213; v67 added 3 NEW observational candidates for +0.070; v68 added 1 NEW Pattern (#86 T1 sub-archetype) + 1 NEW Pattern (#87 Skill-As-Binary-Bootstrap) + 6 NEW OCs for +0.023; **v69 added 1 NEW Pattern #45 sub-typology 45c + 4 NEW OCs for +0.023**. Real observations from genuinely novel subjects (FIRST programming-language at v68 + FIRST purpose-built-for-stealth + FIRST anonymous-corporate-author at v69), not a discipline regression. The library held the sub-0.55 zone v60-v64; v66-v69 operate outside it but within healthy bounds (buffer 0.206 below the 0.95:1 trigger). **Active count trigger REACHED at v67 + maintained at v68 + maintained at v69 (32 candidates) — 3rd CONSECUTIVE WIKI past trigger = corpus-record; mini-audit zone fully met via candidate-count metric** (ratio remains well below at 0.744). **v69 audit batch ~24-25 items = NEW LARGEST in corpus history. v70 audit-before-wiki recommendation ELEVATED to blocking-priority.** Forecast: drift back toward sub-0.55 by v71-v73 absent extreme novelty, accelerated by v69 audit disposition.
...
| `_patterns/03-active-candidates.md` | 32 active candidates with formal statements + observations + N tracking (incl. #85 Platform-Primitive Foundation + #86 T1 sub-archetype #7 + #87 Skill-As-Binary-Bootstrap + Pattern #45 sub-typology 45c + OC-1/OC-2/OC-3 + OC-A through OC-F + OC-G through OC-J) | 96KB+ |
| `_patterns/04-retired-stale.md` | 9 retired patterns + 1 stale candidate with retirement / stale-flag rationale | 12KB |
| `_patterns/05-recent-additions.md` | Strengthening notes + mini-audit decisions, v54 → v69 (incl. v60/v63/v66 mini-audits + v61-v69 wiki ships) | 116KB+ |
