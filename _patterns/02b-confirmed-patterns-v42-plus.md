...
- **(a) Metering / quota / usage-logs** — numeric/dashboard surfacing of usage/cost/quota/logs. **N=4 at audit → N=5 at the v159 CodexBar ship → N=6 at the v165 lazyagent ship** (v89+v109+v157+v158+**v159 CodexBar**+**v165 lazyagent**; sub-archetype overall N=7 → N=8 → **N=11** [+v160 (c) +v164 (b)]).
- **(b) Ambient / affective status-surface** — a reactive desktop-pet/avatar whose state tracks aggregate agent run-state as the *primary* display (affective signal, not a dashboard). **N=3 at audit → N=4 at the v164 oc-claw ship** (v154+v155+v156+**v164 oc-claw**; sub-archetype overall **N=9 → N=10**).
